...
public class CreateAccount extends Activity implements View.OnClickListener {
    ...
    private EditText etEmailCA, etMobileNoCA, etNameCA, etPasswordCA, etRePasswordCA;
    private SharedPreferences profile;


    private void initialize() {
        etEmailCA = (EditText) findViewById(R.id.etEmailAddressCA);
    ...
    public void onClick(View view) {
        ...
        if (etEmailCA.getText().toString().trim().equals("")) {
        ...
        if (etPasswordCA.getText().toString().equals(etRePasswordCA.getText().toString())) {
            ...
            edit.putString("email_address", etEmailCA.getText().toString());
