...
import com.mahediapps.model.AlarmReceiver;
import com.mahediapps.model.DatabaseHelper;

public class Settings extends ActionBarActivity implements View.OnClickListener {

    private LinearLayout lvProfile, lvReminder, lvPassword, lvMobileNo, lvEmailAddress,
    ...
    private void initialize() {
        ...
        lvEmailAddress = (LinearLayout) findViewById(R.id.lvChangeEmailAddressSettings);
        ...
        lvEmailAddress.setOnClickListener(this);
    ...
    public void onClick(final View view) {
        switch (view.getId()) {
            case R.id.lvMyProfileSettings: {
                ...
                final EditText userInstitute = (EditText) dialog.findViewById(R.id.dl_etAcademicInstituteSettings);
                userInstitute.setText(profile.getString("user_institute", ""));
                final EditText user_class = (EditText) dialog.findViewById(R.id.dl_etClassSettings);
                user_class.setText(profile.getString("user_class", ""));

                final EditText user_department = (EditText) dialog.findViewById(R.id.dl_etDepartmentSettings);
                user_department.setText(profile.getString("user_department", ""));
                final EditText user_year = (EditText) dialog.findViewById(R.id.dl_etYearSettings);
                user_year.setText(profile.getString("user_year", ""));
                ...
                bSave.setOnClickListener(new View.OnClickListener() {
                    public void onClick(View view) {
                        ...
                        edit.putString("user_institute", userInstitute.getText().toString());
                        edit.putString("user_class", user_class.getText().toString());
                        edit.putString("user_department", user_department.getText().toString());
                        edit.putString("user_year", user_year.getText().toString());
            ...
            case R.id.lvReminderSettings: {
                ...
                if (state == 0) {
                    ...
                    edit.putInt("reminder_repeater_state", 0);
                    edit.putInt("reminder_repeater_time", -1);
                    edit.putString("reminder_repeater_interval", "alarm is not repeated");
            ...
            case R.id.lvChangeEmailAddressSettings: {
                final Dialog dialog = new Dialog(this);
                dialog.setTitle("Email Address Settings");
                dialog.setContentView(R.layout.dl_email_address_settings);
                final EditText etEmailAddress = (EditText) dialog.findViewById(R.id.dl_etEmailAddressSettings);
                etEmailAddress.setText(profile.getString("email_address", ""));

                Button bCancel = (Button) dialog.findViewById(R.id.dl_bCancelEmailAddressSettings);
                Button bSave = (Button) dialog.findViewById(R.id.dl_bSaveEmailAddressSettings);

                bSave.setOnClickListener(new View.OnClickListener() {
                    public void onClick(View view) {
                        SharedPreferences.Editor edit = profile.edit();
                        edit.putString("email_address", etEmailAddress.getText().toString());
                        edit.commit();

                        dialog.dismiss();
                        Toast.makeText(getApplicationContext(), "Your Email Address is saved successfully !",
                                Toast.LENGTH_SHORT).show();
                    }
                });
    ...
    private void openTimePickerDialog(boolean flag) {
        ...
        timePickerDialog.setMessage("This alarm works only when you forget to keep your dairy before your alarm time !!");
    ...
    public boolean importDatabase() {
        ...
        try {
            ...
            Toast.makeText(this, "No database file is found in your sd card", Toast.LENGTH_SHORT).show();
        }
        return false;
    }
}
